		...
		<aside className="w-full sm:w-1/4 p-4 bg-white rounded shadow">
			<div className="flex gap-2 items-center mb-4">
				...
				<button
					...
					data-active={isOpen}
					className="data-[active='true']:rotate-180 transition-all duration-300"
				>
					<svg
						aria-hidden="true"
						fill="none"
			...
			<ul className="hidden sm:block transition-all duration-300 data-[active='true']:block" data-active={isOpen}>
				<li className="mb-2">
					<a
						href="/messages/123"
