...
export default function Sidebar() {
	return (
		<div className="relative">
			<aside className="fixed -translate-x-full transition-transform sm:translate-x-0 sm:relative p-4 bg-white w-full rounded shadow data-[active='true']:translate-x-0">
